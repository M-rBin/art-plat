...
| LLD 内容规范 | `.claude/ByAgent-knowledge/phase2-design/lld-spec.md` | 三维度内容要求、质量清单 |
| 数据库规范 | `.claude/ByAgent-knowledge/phase3-development/database.md` | 表/字段/索引/必备字段 |
| 后端规范 | `.claude/ByAgent-knowledge/phase3-development/backend.md` | RESTful、统一响应格式 |
| 安全规范 | `.claude/ByAgent-knowledge/conventions/security.md` | 鉴权、数据安全、注入防护 |
