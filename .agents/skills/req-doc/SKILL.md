...
| PRD 语言规范 | Read(".claude/ByAgent-knowledge/phase1-requirements/prd-language.md") | 禁止词汇、替换表 |
| 章节格式规范 | Read(".claude/ByAgent-knowledge/phase1-requirements/section-format.md") | 详细设计章节结构 |
| 质量审查清单 | Read(".claude/ByAgent-knowledge/phase1-requirements/srs-quality-checklist.md") | SRS四维度审查标准 |
| 模块依赖规范 | Read(".claude/ByAgent-knowledge/phase1-requirements/module-dependency.md") | 依赖关系描述方式 |
