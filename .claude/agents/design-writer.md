...
- 设计内容规范：`{PROJECT_PATH}/.claude/ByAgent-knowledge/phase2-design/{DOC_TYPE}-spec.md`

**DOC_TYPE=lld 时额外读取（作为表/接口/安全设计的硬性规范）：**
- `{PROJECT_PATH}/.claude/ByAgent-knowledge/phase3-development/database.md`
- `{PROJECT_PATH}/.claude/ByAgent-knowledge/phase3-development/backend.md`
- `{PROJECT_PATH}/.claude/ByAgent-knowledge/conventions/security.md`
