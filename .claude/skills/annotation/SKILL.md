...
- Read(".claude/ByAgent-knowledge/phase2-design/strategy.md") — 区域划分、什么该标
- Read(".claude/ByAgent-knowledge/phase2-design/content-format.md") — 内容格式、文案要求
- Read(".claude/ByAgent-knowledge/phase2-design/selector-patterns.md") — class 命名规范、注入策略
