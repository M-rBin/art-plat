<!--
  ByAgent - Spec-Driven Agentic Delivery System
  Copyright (c) ByAgent | https://www.axuremart.com

  DO NOT MODIFY THIS FILE MANUALLY.
  This file is auto-generated by ByAgent and will be overwritten on next update.
  Run `npx sdad-ByAgent init` to regenerate.
-->
...
> **版本：v17.0.1** ｜ 更新：`npx sdad-ByAgent@latest init`
...
6. **Tool-Call-Integrity** — 调用工具必须发起真正的结构化工具调用，严禁把工具调用输出成 `call`/`invoke` 等纯文本（详见 `rules/ByAgent-tool-call-integrity.md`）
